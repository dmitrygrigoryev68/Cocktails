...
VALUES (1, 'First Photo','https://cdn.liquor.com/wp-content/uploads/2013/04/ward-eight.jpg','200x400');
insert INTO ingredient(ID, TITLE, DESCRIPTION,PHOTO_ID)
VALUES (1, 'Vodka', '4 cl Vodka',1),
       (2, 'Peach liqueur', '4 cl peach liqueur',1),
       (3, ' Cranberry', '8 cl cranberry juice or Cranberry Rectal',1),
       (4, 'Orange juice', '8 cl of orange juice',1),
       (5, 'Ice', 'Ice cubes',1);
