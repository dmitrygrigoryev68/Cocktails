...
CREATE TABLE `recipe_tags` (
  ...
  UNIQUE KEY `UK_ekysfqlrr7vwoe46lcov7u7oc` (`tags`),
  KEY `FKjiru1slak65kppo369ay3rs42` (`recipe_recipe_id`)
...
REPLACE INTO `recipe_tags` (`recipe_recipe_id`, `tags`) VALUES (1,11),(2,2),(4,13);
...
-- Dump completed on 2019-02-23 22:57:57
