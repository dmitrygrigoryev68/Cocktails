...
CREATE TABLE `recipe_video` (
  ...
  UNIQUE KEY `UK_erwb4k9plryjil4wix8bpnwui` (`video`),
  KEY `FKdcc1uagc88k1if0qougab7ipy` (`recipe_recipe_id`)
...
REPLACE INTO `recipe_video` (`recipe_recipe_id`, `video`) VALUES (1,11),(2,2),(4,13);
...
-- Dump completed on 2019-02-23 22:57:48
